...
| IO values and destructuring             | `good/io_values_destructure.fig`       | `bad/removed_ownership_move_after_pass.fig`  | Unsupported ownership forms such as `fork` are rejected.                                                     |

...
| --------------------------------------- | --------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| declarations/imports/effects            | `good/declarations_imports_effects.fig`       | `bad/effect_row_missing.fig`                 | Calling an imported host effect from a pure function omits the required effect row.                          |
...
| tuples and collections                  | `good/tuples_collections_borrows_frozen.fig`  |                                              | Tuple destructuring and target-typed collection literals check together.                                     |
...
| temporal values, destructuring, effects | `good/ownership_fork_destructure_effects.fig` | `bad/ownership_move_after_pass.fig`          | Removed ownership forms such as `fork` are rejected.                                                         |

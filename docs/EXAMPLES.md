...
| --------------------------------------- | --------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| declarations/imports/IO                 | `good/declarations_imports_effects.fig`       | `bad/external_io_missing.fig`                | External host IO imports must take an explicit `io` executor and return an `io(T)` action.                   |
...
| IO values and destructuring             | `good/ownership_fork_destructure_effects.fig` | `bad/ownership_move_after_pass.fig`          | Removed ownership forms such as `fork` are rejected.                                                         |

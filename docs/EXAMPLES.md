...
| function match bodies and patterns      | `good/function_match_bodies_patterns.fig` | `bad/function_match_body_non_exhaustive.fig` | Function match bodies keep deconstruction and guarded branch results in one declaration.                     |
...
| numeric enums                           | `good/numeric_enums.fig`               | `bad/enum_member_dot.fig`                       | Numeric enum members use associated `Type::Member` syntax and can be inferred as bare match patterns.        |
...
| Wasm boundary values                    |                                        | `bad/external_function_boundary.fig`            | Runtime function values cannot cross public Wasm exports or host IO imports.                                 |

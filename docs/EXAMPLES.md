...
| tuples, collections, borrows, frozen    | `good/tuples_collections_borrows_frozen.fig`  |                                              | Tuple destructuring, target-typed collection literals, borrows, and frozen literals check together.          |

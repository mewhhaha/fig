...
const rules: Record<string, Expression> = {
  ...
  "Type": { kind: "choice", options: [{ kind: "ref", name: "BorrowType" }, { kind: "ref", name: "FrozenType" }, { kind: "ref", name: "FnType" }, { kind: "ref", name: "TypeUnion" }] },

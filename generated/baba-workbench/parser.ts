...
const rules: Record<string, Expression> = {
  ...
  "PipeBindAtom": { kind: "choice", options: [{ kind: "ref", name: "MatchExpr" }, { kind: "ref", name: "Binary" }] },

...
const rules: Record<string, Expression> = {
  ...
  "Decl": {
    kind: "choice",
    options: [{ kind: "ref", name: "TypeFnDecl" }, { kind: "ref", name: "ConstDecl" }, {
      kind: "ref",
      name: "FnDecl",
  ...
  "FnTail": {
    ...
    items: [
      ...
      { kind: "optional", expression: { kind: "ref", name: "EffectRow" } },
      { kind: "ref", name: "Block" },
    ],
  },
  "BranchHint": {
      ...
      { kind: "literal", value: "const" },
      {
        ...
        options: [{ kind: "ref", name: "ImportBindingList" }, {
          ...
          items: [{ kind: "ref", name: "FieldName" }, { kind: "ref", name: "Type" }, {
            kind: "optional",
            expression: { kind: "ref", name: "EffectRow" },
          }],
        }, {
          kind: "sequence",
          items: [{ kind: "ref", name: "LowerIdent" }, {
  ...
  "ImportBindingItems": {
    ...
    options: [{ kind: "literal", value: "}" }, {
      kind: "sequence",
      items: [{ kind: "ref", name: "LowerIdent" }, { kind: "ref", name: "ImportBindingTail" }],
    }],
  },
  "ImportBindingTail": {
    kind: "choice",
  ...
  "DoStrategy": {
    kind: "sequence",
    items: [{ kind: "ref", name: "StaticBuiltin" }, { kind: "literal", value: "(" }, {
      kind: "ref",
      name: "TypeExpr",
    }, { kind: "literal", value: ")" }],
  },
  "DoBlock": {
    ...
    items: [
      { kind: "literal", value: "{" },
      { kind: "repeat", expression: { kind: "ref", name: "DoBlockItem" } },
      { kind: "optional", expression: { kind: "ref", name: "Expr" } },
      { kind: "literal", value: "}" },
    ],
  },
  "DoBlockItem": {
    kind: "choice",
    options: [{ kind: "ref", name: "DoBindStmt" }, { kind: "ref", name: "BlockLetDecl" }, {
      kind: "ref",
      name: "BlockProofConstDecl",
    }],
  },
  "DoBindStmt": {
    kind: "sequence",
    items: [{ kind: "ref", name: "DoBindName" }, { kind: "ref", name: "Expr" }, {
      kind: "literal",
      value: ";",
    }],
  },

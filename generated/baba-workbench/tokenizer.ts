...
export type TokenKind = "identifier" | "number" | "char" | "string" | "fenced_text" | "fenced_template" | "keyword" | "symbol" | "eof" | "CountRepeat" | "FrozenCollectionOpen" | "FrozenTypeOpen" | "CollectionOpen" | "CollectionClose" | "Number" | "Char" | "String" | "LiteralType" | "LowerIdentRepeat" | "PascalIdentRepeat" | "TypeRepeatPrefix" | "LowerIdent" | "PascalIdent";
...
const tokenPatterns: Array<{ kind: string; pattern: RegExp }> = [
  ...
  { kind: "FrozenCollectionOpen", pattern: new RegExp("#\\[", "y") },
  { kind: "FrozenTypeOpen", pattern: new RegExp("#\\(", "y") },
  { kind: "CollectionOpen", pattern: new RegExp("<", "y") },
  { kind: "CollectionClose", pattern: new RegExp(">", "y") },

...
export type TokenKind = "identifier" | "number" | "char" | "string" | "fenced_text" | "fenced_template" | "keyword" | "symbol" | "eof" | "CountRepeat" | "Number" | "Char" | "String" | "LiteralType" | "LowerFieldName" | "LowerIdentRepeat" | "PascalIdentRepeat" | "TypeRepeatPrefix" | "LowerIdent" | "PascalIdent";
...
const tokenPatterns: Array<{ kind: string; pattern: RegExp }> = [
  ...
  { kind: "LowerFieldName", pattern: new RegExp("[a-z_][a-z0-9_]*\\s*:", "y") },

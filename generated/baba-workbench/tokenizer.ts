...
export type TokenKind = "identifier" | "number" | "char" | "string" | "fenced_text" | "fenced_template" | "keyword" | "symbol" | "eof" | "CountRepeat" | "CollectionOpen" | "CollectionClose" | "Number" | "Char" | "String" | "LiteralType" | "LowerIdentRepeat" | "PascalIdentRepeat" | "TypeRepeatPrefix" | "DoBindName" | "LowerIdent" | "PascalIdent";
...
const tokenPatterns: Array<{ kind: string; pattern: RegExp }> = [
  ...
  { kind: "DoBindName", pattern: new RegExp("[a-z_][a-z0-9_]*[ \\t\\r\\n]*<-", "y") },

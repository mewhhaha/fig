...
export type TokenKind = "identifier" | "number" | "char" | "string" | "fenced_text" | "fenced_template" | "keyword" | "symbol" | "eof" | "CountRepeat" | "CollectionOpen" | "Number" | "Char" | "String" | "LiteralType" | "OperatorSymbol" | "LowerIdentRepeat" | "PascalIdentRepeat" | "TypeRepeatPrefix" | "LowerIdent" | "PascalIdent";
...
const tokenPatterns: Array<{ kind: string; pattern: RegExp }> = [
  ...
  { kind: "Number", pattern: new RegExp("[0-9](_?[0-9])*(\\.[0-9](_?[0-9])*)?(i32|u32|i64|u64|f32|f64)?", "y") },
  ...
  { kind: "OperatorSymbol", pattern: new RegExp("[+\\-*\\/%<>=!&|^$]+", "y") },
...
const lineComment = "//";
const operatorSymbolChars = new Set(["+","-","*","/","%","<",">","=","!","&","|","^","$"]);
const reservedOperatorSymbols = new Set(["->","=>","<-","="]);
